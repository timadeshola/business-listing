...
public class CountryControllerTest {
    ...
    public void createCountryEndpointTest() throws Exception {
        CountryRequest request = CountryRequest.builder().name("Jamaica").countryCode("JM").build();
    ...
    public void updateCountryEndpointTest() throws Exception {
        CountryRequest request = CountryRequest.builder().name("Nigeria").countryCode("NGR").build();
        String requestJson = AppUtils.toJSON(request);
