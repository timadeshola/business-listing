...
public class CategoryControllerTest {
    ...
    @Test
    public void createCategoryEndpointTest() throws Exception {
        CategoryRequest request = CategoryRequest.builder().name("Engineering").build();
    ...
    @Test
    public void updateCategoryEndpointTest() throws Exception {
        CategoryRequest request = CategoryRequest.builder().name("Finance").build();
        String requestJson = AppUtils.toJSON(request);
        mockMvc.perform(put("/api/v1/categories/{categoryId}", "1")
                .header("Authorization", accessToken)
                .contentType(MediaType.APPLICATION_JSON)
                .content(requestJson)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    public void deleteCategoryEndpointTest() throws Exception {
    ...
    @Test
    public void findAllCategoriesEndpointTest() throws Exception {
    ...
    public void findCountryByNameEndpointTest() throws Exception {
        mockMvc.perform(get("/api/v1/categories/{name}", "FINANCE")
                .header("Authorization", accessToken)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
